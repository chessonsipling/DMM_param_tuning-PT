...
params = {
    ...
    'axes.prop_cycle': cycler('linestyle', ['-', '--', ':']) * cycler('color', [plt.get_cmap('jet')(i/10) for i in range(10)]),
}
plt.rcParams.update(params)
#plt.style.use("seaborn-v0_8-colorblind") #may have to use 'seaborn-colorblind', depending on version
